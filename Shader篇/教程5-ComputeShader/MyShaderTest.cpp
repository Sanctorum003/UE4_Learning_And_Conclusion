...
)
{
	...
	*/
	...
	FLinearColor testLin = Bitmap[11];
	DrawTestShaderRenderTarget_RenderThread(RHICmdList, OutputRenderTargetResource, FeatureLevel, TextureRenderTargetName,testLin , nullptr, FMyShaderStructData());
...
void UTestShaderBlueprintLibrary::UseComputeShader(UTextureRenderTarget2D* OutputRenderTarget, AActor* selfref)
{
	check(IsInGameThread());
